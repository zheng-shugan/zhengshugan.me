...
![Pasted Graphic 7.png](Attachments/Pasted Graphic 7.png)  
...
![A 应用程序](Attachments/Pasted Graphic.png)  
...
![- OS - macOS Tahoe - Apple（中国大陆）](Attachments/Pasted Graphic.png)  
  
![Q macOS - Microsoft Word](Attachments/Pasted Graphic 2.png)  
  
也可以通过 「cmd + 数字」来选择应用、文档、快捷指令、剪切板，进一步的减小搜索的范围提高检索的精度。  
  
![Pasted Graphic 4.png](Attachments/Pasted Graphic 4.png)  
  
在搜索结果上最新的聚焦搜索也提供了更多的选择，除了本机内容之外还可以搜索应用内的信息，进一步扩展了搜索的内容范围，这一点也是目前其他第三方启动器无法做到的一点。  
  
![macOS 26 正式版有哪些功能是值得关注的？](Attachments/Pasted Graphic 3.png)  
  
这次的聚焦搜索也终于支持了为应用添加「快捷键」，比如我现在想快速创建一个备忘录，我只需要在聚焦搜索里敲下 「an」 就可以创建一个备忘录。  
  
![mac_1758346789226.png](Attachments/mac_1758346789226.png)  
  
![回归系统自带软件](Attachments/mac_1758346827995.png)  
...
![Pasted Graphic 5.png](Attachments/Pasted Graphic 5.png)  
